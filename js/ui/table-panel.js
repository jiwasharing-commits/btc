(function () {
  ...
  function buildPanelData(options = {}) {
    return { title: "Table", rows: [{ label: "Status", value: window.BtcDash.config?.UI_PANEL_CONFIG?.referenceOnlyText || "Reference only" }] };
  }
  ...
  window.BtcDash.ui.panels.table = { renderPanel, buildPanelData, renderEmptyState };
})();
