(function () {
  ...
  function buildPanelData(options = {}) {
    return { title: "Channel", rows: [{ label: "Status", value: window.BtcDash.config?.UI_PANEL_CONFIG?.referenceOnlyText || "Reference only" }] };
  }
  ...
  window.BtcDash.ui.panels.channel = { renderPanel, buildPanelData, renderEmptyState };
})();
