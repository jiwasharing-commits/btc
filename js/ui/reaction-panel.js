(function () {
  ...
  function buildPanelData(options = {}) {
    return { title: "Reaction Study", rows: [{ label: "Status", value: window.BtcDash.config?.UI_PANEL_CONFIG?.referenceOnlyText || "Reference only" }] };
  }
  ...
  window.BtcDash.ui.panels.reaction = { renderPanel, buildPanelData, renderEmptyState };
})();
