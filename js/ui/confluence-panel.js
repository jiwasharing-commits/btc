(function () {
  ...
  function buildPanelData(options = {}) {
    return { title: "Confluence", rows: [{ label: "Status", value: window.BtcDash.config?.UI_PANEL_CONFIG?.referenceOnlyText || "Reference only" }] };
  }
  ...
  window.BtcDash.ui.panels.confluence = { renderPanel, buildPanelData, renderEmptyState };
})();
