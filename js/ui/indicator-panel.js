(function () {
  ...
  function buildPanelData(options = {}) {
    return { title: "Indicator", rows: [{ label: "Status", value: window.BtcDash.config?.UI_PANEL_CONFIG?.referenceOnlyText || "Reference only" }] };
  }
  ...
  window.BtcDash.ui.panels.indicator = { renderPanel, buildPanelData, renderEmptyState };
})();
